                ...
                <div className="h-14 bg-white border-b border-slate-200 px-4 flex items-center justify-between sticky top-0 z-30">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 text-[11px] font-bold text-slate-400 uppercase tracking-wider border-r border-slate-200 pr-4">
                            ...
                            <ChevronRight size={10} />
                            <span className="text-slate-900 uppercase tracking-widest leading-none">Checkout Entry</span>
                        </div>
                        <div className="flex items-center gap-1.5 px-2 py-0.5 bg-emerald-50 border border-emerald-100 rounded-sm">
                            <ShieldCheck size={10} className="text-emerald-500" />
                            <span className="text-[9px] font-bold text-emerald-600 uppercase tracking-widest leading-none">Online & Calibrated</span>
                        </div>
                    </div>
            ...
            <div className="w-full lg:w-[440px] bg-white flex flex-col h-full shadow-2xl relative z-20">
                <div className="h-14 border-b border-slate-200 px-6 flex items-center justify-between bg-slate-50/50">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.2em]">Transaction Ledger</h2>
                    </div>
                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest tabular-nums">{cart.length} LINE ITEMS</span>
                </div>
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar">
                    ...
                    {cart.length === 0 && (
                        <div className="py-32 flex flex-col items-center justify-center text-center px-10">
                            ...
                            <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Matrix Empty</h3>
                            <p className="text-[10px] text-slate-300 font-bold uppercase tracking-widest mt-2">Initialize Sale Entry</p>
                        </div>
                    )}
                </div>
                ...
                <div className="p-6 bg-slate-900 text-white">
                    <div className="space-y-4 mb-8">
                        <div className="flex justify-between items-center opacity-60">
                            <span className="text-[10px] font-black uppercase tracking-widest">Aggregate Subtotal</span>
                            <span className="text-[11px] font-black tabular-nums">₹{(total || 0).toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center opacity-60">
                            <span className="text-[10px] font-black uppercase tracking-widest">Tax Provisioning</span>
                            <span className="text-[11px] font-black tabular-nums">₹0.00</span>
                        </div>
                        <div className="h-px bg-slate-800" />
                        <div className="flex justify-between items-end">
                            <div className="flex flex-col">
                                <span className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mb-1">Payable Volume</span>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Calibration Module Active</p>
                            ...
                            <div className="bg-slate-50 border border-slate-200 rounded-sm p-8 text-center mb-8">
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    ...
                                    <span className="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em]">Stable Metric Integration</span>
                                </div>
                            </div>
            ...
            <AnimatePresence>
                {showCheckout && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
                        ...
                        >
                            <h3 className="text-xs font-black text-slate-900 tracking-[0.3em] uppercase mb-12 text-center">Protocol Settlement Selection</h3>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-12">
                                ...
                                >
                                    ...
                                    <span className="font-black uppercase text-[10px] tracking-widest text-slate-400 group-hover:text-slate-900">Treasury Cash</span>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <span className="font-black uppercase text-[10px] tracking-widest text-slate-400 group-hover:text-slate-900">Digital Gateway</span>
                                </button>
                            </div>

                            <button onClick={() => setShowCheckout(false)} className="w-full text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors">Abort Settlement</button>
                        </motion.div>
                    </div>
                )}
            </AnimatePresence>
                    ...
                    <div className="fixed inset-0 z-[110] flex items-center justify-center p-6">
                        ...
                        >
                            <div className="p-8 flex flex-col items-center border-b border-dashed border-slate-200">
                                ...
                                <h2 className="text-xs font-black text-slate-900 uppercase tracking-[0.3em] mb-1">Settlement Finalized</h2>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Protocol #POS-9281-XC</p>
                            </div>
                            ...
                            <div className="p-8 space-y-4">
                                ...
                                <div className="flex justify-between text-[9px] font-bold uppercase text-slate-400 tracking-widest">
                                    ...
                                    <span>Terminal Internal</span>
                                </div>
                                <div className="flex justify-between text-[9px] font-bold uppercase text-slate-400 tracking-widest">
                                    <span>Time Registry</span>
