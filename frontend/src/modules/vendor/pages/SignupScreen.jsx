...
import { Sprout, Mail, Lock, Loader2, ArrowRight, User, Phone, MapPin, FileText, CreditCard, Building2, Camera, Upload, X } from 'lucide-react';
            ...
            <div 
                onClick={() => {
                    if (window.flutter_inappwebview) {
                        setActiveUploadField({ name, label, fileRef, Icon });
                    } else {
