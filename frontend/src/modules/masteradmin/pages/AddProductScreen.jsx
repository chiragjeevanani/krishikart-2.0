                        ...
                        <div className="bg-white border border-slate-200 rounded-sm shadow-sm overflow-hidden group">
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-0.5">Tags & Meta</label>
                                    <div className="flex flex-wrap gap-2">
                                        {['Organic', 'Local', 'Fresh'].map(tag => (
                                            <span key={tag} className="px-2 py-1 bg-slate-100 text-slate-500 text-[9px] font-black uppercase tracking-wider rounded-sm border border-slate-200 flex items-center gap-1.5 cursor-pointer hover:bg-slate-200 transition-colors">
                                                <Tag size={10} />
                                                {tag}
                                            </span>
                                        ))}
                                        <button className="px-2 py-1 border border-dashed border-slate-300 text-slate-400 text-[9px] font-black uppercase tracking-wider rounded-sm hover:border-emerald-500 hover:text-emerald-600 transition-all flex items-center gap-1">
                                            <Plus size={10} />
                                            Add
                                        </button>
                                    </div>
